...
% タイトル
\def\title{ヘテロジニアス量子計算のための量子ビット割り当て}
% 英語タイトル
\def\etitle{Qubit Allocation For Heterogeneous Quantum Computing}
% 著者(日本語)
\def\author{中井 慎}
% 著者(英語)
...
\input{src/3_related_works}
\input{src/4_problem_definition_and_proposal}
\input{src/5_heqsim}
